            ...
            <div id="viewMode">
                <div class="row mb-4">
                    ...
                    <div class="row text-dark">
                        ...
                        <div class="col-md-6 mb-2"><strong>First Name:</strong> <span id="modalFirstname"></span></div>
                        <div class="col-md-6 mb-2"><strong>Middle Name:</strong> <span id="modalMiddlename"></span></div>
