...
<?php 
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        if ($resolution_id > 0) {
            ...
            $sql = "SELECT timestamp FROM history_log WHERE file_id = ? AND file_type = 'minutes' ORDER BY timestamp DESC LIMIT 1";
    ...
    ***********************************-->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Global function to load minutes history
            window.loadHistory = function () {
                let minutesId = "<?php echo $minutes_id; ?>";
